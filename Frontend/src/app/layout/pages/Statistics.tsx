...
export default observer(function Statistics() {
  ...
  return (
    <>
      <div className="min-h-screen flex flex-row items-start mt-20 sm:mt-0 sm:items-center justify-center py-2 px-2 sm:px-6 lg:px-8">
        <div className="grid grid-cols-4 w-full">
          <div className="relative col-start-1 col-span-4 2xl:col-start-2 2xl:col-span-2 scrollbar-hide overflow-x-auto shadow-md rounded-lg">
            <table className="text-sm w-full table-auto font-semibold text-left text-gray-500 dark:text-gray-400">
              <thead className="text-xxs sm:text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                <tr>
                  ...
                  <th
                    scope="col"
                    className="py-2 sm:py-8 text-red-400 text-center"
                  >
                    Red
                  </th>
                  <th
                    scope="col"
                    className="py-2 sm:py-8 text-fuchsia-400 text-center"
                  >
                    Fuchsia
                  </th>
                  <th
                    scope="col"
                    className="py-2 sm:py-8 text-blue-400 text-center"
                  >
                    Blue
                  </th>
                  <th
                    scope="col"
                    className="py-2 sm:py-8 text-sky-400 text-center"
                  >
                    Sky
                  </th>
                  <th
                    scope="col"
                    className="py-2 sm:py-8 text-green-400 text-center"
                  >
                    Green
                  </th>
                  <th
                    scope="col"
                    className="py-2 sm:py-8 text-amber-400 text-center"
                  >
                    Amber
                  </th>
                  <th
                    scope="col"
                    className="py-2 sm:py-8 text-slate-400 text-center"
                  >
                    Slate
                  </th>
                </tr>
                  ...
                  ({
                    ...
                    return (
                      ...
                      >
                        ...
                        <td className="px-4 text-center text-xs whitespace-nowrap sm:text-sm">
                          {totalAmount}
                        </td>
                        <td className="px-4 text-center text-xs whitespace-nowrap sm:text-sm">
                          {red}
