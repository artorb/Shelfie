    ...
    return (
        <>
            <div className="min-h-screen dark:bg-slate-900 bg-opacity-80 flex flex-row  justify-center">
                <div
                    className="flex bg-[url('/src/assets/grains.avif')] shadow-lg dark:shadow-none shadow-teal-900/[.3] dark:bg-[url('/src/assets/grains-dark2.avif')] sm:mt-16 mb-4 mt-4 bg-cover w-full md:w-full h-full p-12 flex-col shadow-xl">
                    <div className="mx-auto text-center">
                        <section className="text-gray-600 body-font">
                            <div
                                className="container px-5 sm:h-full py-12 sm:py-24 mx-auto flex flex-wrap flex-col w-full lg:flex-row items-center">
                                <div
                                    className="xl:1/3 lg:w-1/2 md:w-3/5 w-4/5 md:mb-6 bg-black rounded-md dark:bg-slate-900 dark:bg-opacity-40 bg-opacity-70 lg:pr-2">
                                ...
                                <div
                                    className="xl:w-1/3 lg:w-1/2 md:w-3/5 bg-gray-100 bg-opacity-90 dark:bg-slate-900 rounded-md p-6 flex flex-col md:ml-auto w-full xs:w-4/5 mx-auto mt-10 md:mt-0">
                                    <svg
                                    ...
                                    <div className="mb-4">
                                        ...
                                        >
                                            {({handleSubmit, isSubmitting, errors, status, setStatus}) => (
