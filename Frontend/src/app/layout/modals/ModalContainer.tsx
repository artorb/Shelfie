...
export default observer(function ModalContainer() {
  ...
  const { cancelSelectedIngredient } = ingredientStore;
  const { cancelSelectedStorage } = storageStore;
  const { closeModal: close, modal } = modalStore;
  ...
  return (
    <>
      <Transition.Root appear show={modal.open} as={Fragment}>
        <Dialog
          as="div"
        ...
        >
          <Transition.Child
            ...
            leaveTo="opacity-0"
          >
            <div className="fixed inset-0 bg-gray-900 backdrop-filter backdrop-blur dark:bg-indigo-500 bg-opacity-30" />
          </Transition.Child>
          ...
          <div className="fixed z-40 inset-0 overflow-y-auto">
            <div className="flex min-h-full items-start sm:items-center justify-center p-4 text-center">
              ...
              >
                <Dialog.Panel className="relative w-full max-w-md dark:bg-indigo-800 transform overflow-hidden rounded-2xl bg-gray-100 p-6 text-left align-middle shadow-xl transition-all">
