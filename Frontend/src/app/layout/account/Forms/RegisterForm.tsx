...
const RegisterForm = () => {
  ...
  const validationSchemaRegistration = Yup.object({
    username: Yup.string()
      .required("Required to have a username")
      .min(4)
      .max(20),
  ...
  return (
    <>
      <div className="bg-gray-100 bg-opacity-90 dark:bg-slate-900 rounded-md p-6 flex flex-col md:ml-auto w-full xs:w-4/5 mx-auto mt-10 md:mt-0">
        <svg
