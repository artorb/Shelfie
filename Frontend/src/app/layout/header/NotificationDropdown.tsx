          ...
          <>
            <Popover.Button
              ...
              className="inline-flex justify-center
                                            rounded-full outline-2 px-1.5 py-1.5 mx-2 text-sm font-medium text-white bg-sky-200 bg-opacity-20
              ...
              <svg
                className={`${
                  expiringIngredients.length === 0
                    ? "text-gray-200"
                    : "animate-pulse text-amber-100 dark:text-indigo-300 dark:group-hover:text-indigo-100 group-hover:text-amber-200"
                } w-10 h-10 stroke-current transition-colors duration-200`}
                viewBox="0 0 24 24"
                fill="none"
            ...
            >
              <Popover.Panel className="fixed z-10 mt-8 w-screen max-w-sm -translate-x-1/2 transform px-4 sm:px-0 lg:max-w-3xl">
                <div className="overflow-hidden rounded-lg shadow-lg ring-1 ring-black ring-opacity-5">
                          ...
                          <p className="text-sm font-medium text-gray-900 dark:text-gray-200 flex">
                            ...
                            <span
                              className={`${colorizeTag(
                                item.colorTag
                              )} rounded-full my-auto ml-2 w-3 h-3`}
                            ></span>
                          </p>
                          <p className="text-sm mt-1 text-gray-500 dark:text-gray-200">
                            <span className="">
                              {formatDistanceToNow(item.expirationDate) +
                                " left"}
                            </span>
                          </p>
                        </div>
                  ...
                  <div className="bg-gray-300 dark:bg-primary_dark-100 dark:border-gray-100/10 border-t-2 border-gray-400/20 p-4">
                    <div className="flow-root hover:cursor-default rounded-md px-2 py-2 transition duration-150 ease-in-out hover:bg-gray-400/20 dark:hover:bg-primary_dark-200/30  focus:outline-none">
                      ...
                      <span className="block text-sm text-gray-500 dark:text-gray-200">
                        These edibles have 30 or less days until the expiration
                        date.
                      </span>
                    </div>
                  </div>
