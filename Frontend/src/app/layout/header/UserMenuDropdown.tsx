    ...
    return (
        <div className="hidden md:block flex items-center transition-color duration-200 focus:outline-none">
            <Menu as="div" className="relative inline-block text-left">
                ...
                >
                    <Menu.Items
                        className="absolute right-0 center-block w-48 mt-2 origin-top-right bg-metallic-200 shadow-inner dark:bg-gray-800 divide-y-2 divide-gray-100/10 dark:divide-gray-600/20 rounded-md shadow-lg ring-2 ring-primary-100/50 dark:ring-indigo-700/50 focus:outline-none">
                        <div
                        ...
                        <div
                            className="px-2 py-2 bg-metallic-400 dark:bg-primary_dark-100 rounded-b-md">
                            <DropdownMenuItem text={'Logout'} to={'/login'} icon={<LogOutIcon/>}
